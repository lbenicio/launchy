...
-- Arguments: disk-name app-name
--   osascript scripts/dmg-setup.applescript Launchy-setup Launchy
...
on run argv
    ...
    tell application "Finder"
        tell disk diskName
            ...
            set position of item (appName & ".app") of container window to {160, 185}
